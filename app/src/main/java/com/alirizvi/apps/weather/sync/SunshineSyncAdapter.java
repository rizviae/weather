package com.alirizvi.weather.sync;
...
import com.alirizvi.weather.MainActivity;
import com.alirizvi.weather.R;
import com.alirizvi.weather.Utility;
...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    public void onPerformSync(Account account, Bundle extras,
        ...
        try {
            ...
            getWeatherDataFromJson(forecastJsonStr, numDays, location);
        } catch (IOException e) {
...
//        long locationID = addLocation(locationSetting, cityName, cityLatitude, cityLongitude);
    ...
    private long addLocation(String locationSetting, String cityName, double lat, double lon) {
        ...
        if (cursor.moveToNext()) {
            ...
            Uri insertUri = getContext().getContentResolver().insert(WeatherContract.LocationEntry.CONTENT_URI, contentValues);
    ...
    private void notifyWeather() {
        ...
        if (System.currentTimeMillis() - lastSync >= DAY_IN_MILLIS) {
            ...
            if (cursor.moveToFirst()) {
                ...
                if (Utility.shouldSendNotifications(context)) {
                    ...
                    nm.notify(WEATHER_NOTIFICATION_ID, notificationBuilder.build());
                }
